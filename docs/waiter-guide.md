---
title: Waiter Guide
description: How to open tables, take orders, close checks, and handle payments in TacoFloor.
role: waiter
category: user-guide
order: 1
...
The main screen shows every table in the restaurant as a card. Each card is color-coded by status:
...
1. Find the table card matching their table number — it will be **Closed** (dark)
2. Tap **Open table**
3. Enter the number of guests
4. Tap **Open table** to confirm

The card turns green and is now active. You're ready to take the order.

> **Can't find the table?** Use the filter bar and select **Closed** to show only available tables.
...
1. Tap **Order** on the table card
2. The menu opens — use the **+** and **−** buttons next to each dish to add or remove items
3. The summary at the bottom updates in real time with the running total
4. Tap **Save order** when you're done

You can come back and add more items at any time while the table is open. Just tap **Order** again, make your changes, and save.

> **Tip:** Save the order as soon as you take it, even if guests haven't finished ordering. You can always add more items later. This keeps the table total accurate on the floor grid.
...
**I can't close the check — nothing happens or I see a warning.**
